...
import { BackHandler, GestureResponderEvent, Pressable, StyleSheet, Text, View } from 'react-native';
import { Portal as PRender } from './portal/portal';
import * as Slot from './slot';
import { useControllableState } from '@/core/hooks/use-controllable-state';
import { ComponentPropsWithAsChild } from '@/core/types/component-as-child';
